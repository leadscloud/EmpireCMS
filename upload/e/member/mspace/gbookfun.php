...
function AddMemberGbook($add){
	...
	$ip=egetip();
	$sql=$empire->query("insert into {$dbtbpre}enewsmembergbook(userid,isprivate,uid,uname,ip,addtime,gbtext,retext) values($userid,$isprivate,$uid,'$uname','$ip','$addtime','$gbtext','');");
