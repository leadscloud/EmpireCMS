...
<title>调用地址</title><table width="100%" border="0" cellpadding="3" cellspacing="1" class="tableborder">
  ...
  <tr bgcolor="#FFFFFF"> 
    ...
    <td height="25"> <div align="center"><a href="js.php?classid=<?=$ttid?>&js=<? echo urlencode($jspath."newnews.js");?>" target="_blank">预览</a></div></td>
  </tr>
  <tr bgcolor="#FFFFFF"> 
    <td height="25">热门信息JS:</td>
    <td height="25"> <input name="textfield3" type="text" value="<?=$jspath?>hotnews.js" size="35"></td>
    <td height="25"> <div align="center"><a href="js.php?classid=<?=$ttid?>&js=<? echo urlencode($jspath."hotnews.js");?>" target="_blank">预览</a></div></td>
  </tr>
  <tr bgcolor="#FFFFFF"> 
    <td height="25">推荐信息JS:</td>
    <td height="25"> <input name="textfield4" type="text" value="<?=$jspath?>goodnews.js" size="35"></td>
    <td height="25"> <div align="center"><a href="js.php?classid=<?=$ttid?>&js=<? echo urlencode($jspath."goodnews.js");?>" target="_blank">预览</a></div></td>
  </tr>

  <tr bgcolor="#FFFFFF"> 
    <td height="25">热点评论信息JS:</td>
    <td height="25"> <input name="textfield4" type="text" value="<?=$jspath?>hotplnews.js" size="35"></td>
    <td height="25"> <div align="center"><a href="js.php?classid=<?=$ttid?>&js=<? echo urlencode($jspath."hotplnews.js");?>" target="_blank">预览</a></div></td>
  </tr>
  <tr bgcolor="#FFFFFF"> 
    <td height="25">头条信息JS:</td>
    <td height="25"> <input name="textfield4" type="text" value="<?=$jspath?>firstnews.js" size="35"></td>
    <td height="25"> <div align="center"><a href="js.php?classid=<?=$ttid?>&js=<? echo urlencode($jspath."firstnews.js");?>" target="_blank">预览</a></div></td>
  </tr>
</table>
