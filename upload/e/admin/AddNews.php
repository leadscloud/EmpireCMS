...
<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
  <tr> 
	...
	<?=$enews=='EditNews'?'[<a href="user/ListDolog.php?classid='.$classid.'&id='.$id.'" target="_blank">查看本信息操作日志</a>]':''?>
      </div></td>
  </tr>
</table>
  ...
  <form name="searchinfo" method="GET" action="ListNews.php">
    <tr> 
      <td width="42%" title="增加信息后使用本操作将信息显示到前台"> <select name="dore">
        ...
        </select> <input type="button" name="Submit12" value="提交" onclick="self.location.href='ecmsinfo.php?enews=AddInfoToReHtml<?=$addecmscheck?>&classid=<?=$classid?>&dore='+document.searchinfo.dore.value;"> 
      </td>
    ...
    <tr bgcolor="#FFFFFF"> 
      <td height="32" colspan="2"> <div align="right">原因: 
          ...
          <input name="ecmsfrom" type="hidden" id="ecmsfrom" value="<?=$_SERVER['HTTP_REFERER']?>">
...
<div class="tab-pane" id="TabPane1">
	...
	<div class="tab-page" id="baseinfo">        
		...
		<table width="100%" align="center" cellpadding="3" cellspacing="1" class="tableborder">
            ...
            <input name="oldzcids" type="hidden" id="oldzcids"></td>
			</tr>
		</table>
		<?php
		include($modfile);
			...
			<tr>
              ...
              <tr> 
                <td height="25" bgcolor="#FFFFFF">TAGS&nbsp;&nbsp;&nbsp;&nbsp;: 
                  ...
                  <input type="button" name="Submit" value="选择" onclick="window.open('tags/ChangeTags.php?form=add&field=infotags','','width=700,height=550,scrollbars=yes');">
                  <?=$infotag_copykeyboard?>
			  ...
			  ?>
                ...
                <td>所属专题</td>
						...
						<tr> 
							<td height="25" bgcolor="#FFFFFF"><a href="#empirecms" onclick="window.open('special/PushToZt.php?sinfo=1&classid=<?=$classid?>&id=<?=$id?>','PushToZt','width=360,height=500,scrollbars=yes,left=300,top=150,resizable=yes');">点击选择信息所属专题</a></td>
						</tr>
					</table>
			<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#DBEAF5">
              <tr> 
